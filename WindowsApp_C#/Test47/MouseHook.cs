...
namespace Test47
{
    ...
    public class MouseHook
    {
        ...
        private int MouseHookProc(int nCode, IntPtr wParam, IntPtr lParam)
        {
            ...
            else
            {
                if (MouseClickEvent != null)
                {
                    ...
                    MouseClickEvent(this, new MouseEventArgs(button, clicklock, 0, 0, 0));
                }
                ...
                if (KeyBoardEvent != null)
                {
                    ...
                    KeyBoardEvent(this, new KeyPressEventArgs((char)wParam));
                }
        ...
        public delegate void KeyBoardHandler(object sender, KeyPressEventArgs e);
        public event KeyBoardHandler KeyBoardEvent;
